...
parser.add_argument("--superficial_dir", type=str, default="D:/A_Project/OCTA-Net/code/OCTA-Net/results/superficial", help="path to folder for getting superficial maps")
parser.add_argument("--deep_dir", type=str, default="D:/A_Project/OCTA-Net/code/OCTA-Net/results/deep", help="path to folder for getting deep maps")
parser.add_argument("--all_dir", type=str, default="D:/A_Project/OCTA-Net/code/OCTA-Net/results/all", help="path to folder for saving fusion maps")
