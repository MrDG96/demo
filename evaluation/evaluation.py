...
parser.add_argument("--prob_dir", type=str, default="D:/A_Project/FAZ-Net/evaluation/prob", help="path to folder for saving probability maps")
parser.add_argument("--pred_dir", type=str, default="D:/A_Project/FAZ-Net/evaluation/pred", help="path to folder for saving prediction maps")
parser.add_argument("--gt_dir", type=str, default="D:/A_Project/FAZ-Net/evaluation/gt", help="path to folder for saving ground truth")
