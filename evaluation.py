...
def calc_acc(pred_arr, gt_arr, kernel_size=(1, 1)):
...
def calc_pre(pred_arr, gt_arr, kernel_size=(1, 1)):
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
    pre = TP / (FP + TP + 1e-12)
...
def calc_sen(pred_arr, gt_arr, kernel_size=(1, 1)):
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
    sen = TP / (FN + TP + 1e-12)
...
def calc_fdr(pred_arr, gt_arr, kernel_size=(1, 1)):
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
    fdr = FP / (FP + TP + 1e-12)
...
def calc_spe(pred_arr, gt_arr, kernel_size=(1, 1)):
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
    spe = TN / (FP + TN + 1e-12)
...
def calc_gmean(pred_arr, gt_arr, kernel_size=(1, 1)):
...
def calc_bacc(pred_arr, gt_arr, kernel_size=(1, 1)):
    TPR = calc_sen(pred_arr, gt_arr, kernel_size=kernel_size)
    TNR = calc_spe(pred_arr, gt_arr, kernel_size=kernel_size)

    return (TPR + TNR) / 2


def calc_kappa(pred_arr, gt_arr, kernel_size=(1, 1)):
...
def calc_iou(pred_arr, gt_arr, kernel_size=(1, 1)):
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
...
def calc_dice(pred_arr, gt_arr, kernel_size=(1, 1)):
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
